...
// ANSWER: Honestly I'm not really sure, maybe cuz they both have a for loop
...
// ANSWER: The cached method will be faster becuase it only has to run the math once

// Now fill this out and run your file

// CREATE A NEW INSTANCE OF YOUR CLASS
const newSquareNmbr = new Numbers;

console.time("not memoized function time");
console.log(noCacheNumbers(8));
console.log(noCacheNumbers(8));
console.log(noCacheNumbers(8));
console.log(noCacheNumbers(8));
...
console.log(newSquareNmbr.square(8));
console.log(newSquareNmbr.square(8));
console.log(newSquareNmbr.square(8));
console.log(newSquareNmbr.square(8));
